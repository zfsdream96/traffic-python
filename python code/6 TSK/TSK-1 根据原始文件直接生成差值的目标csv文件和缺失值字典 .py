...
'''
这里其实不用set函数转来转去，可以直接用series下面的.unique函数

list(set(di)) ==  bdata['O'].unique().tolist()
...
frame.to_csv('C:/Users/zfsdr/OneDrive - stu.scu.edu.cn/Desktop/nodistance2.csv')