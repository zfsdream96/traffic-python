...
ceil((GETOFFLONGITUDE-103.6985766)/0.01193061)*100+ ceil((GETOFFLATITUDE -30.3159936)/0.0098227) as BB,count(*) as 计数,
sum(operationmil)as 总里程,sum (operationamount) as 总金额,sum (operationtime) as 总时间
